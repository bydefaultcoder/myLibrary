    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, to='customAdmin.customuser')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, to='customAdmin.customuser')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('adhar_no', models.CharField(max_length=12, unique=True, validators=[django.core.validators.MaxLengthValidator(12), django.core.validators.MinLengthValidator(12)])),
                ('status', models.CharField(choices=[('enrolled', 'Enrolled'), ('alloted', 'Alloted'), ('suspended', 'Suspended')], default='active', max_length=10)),
                ('created_by', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, to='customAdmin.customuser')),
            ],
            options={
